      ...
      <section id='section1' className={`${styles.section1} d-flex`}>
        <div className='d-flex flex-md-row flex-column w-100'>
          ...
          <div className='d-flex flex-column col-12 col-md-4 p-4 justify-content-center'>
            <h1 className={`fs-3 mb-2 px-5 ${styles.description}`}>Enjoy the magic of VietNam Hotel.</h1>
      ...
      <section id='section2' className={styles.section2}>
        <div className={styles.pinWrapSticky}>
          <div className={styles.pinWrap}>
            <h2 className='m-4 d-flex align-self-center balance'>Xin chào VietNam.</h2>
            <Image
              src={index4}
              alt='Hotel pool view'
              width={2000}
